          ...
          <div class="goodsPanel">
            ...
            <div class="goodsBody">
              ...
              <div class="goodsItem">
                ...
                <span class="goodsCon">在合法医院做试管婴儿治疗女性，取卵前购买。<em>20~42</em>周岁</span>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      console.log(dateFormat(new Date(),'yyyymmdd','HHmmdd',''),'-----------')
      let self = this
    ...
    methods:{
      ...
      keepTop(ele,h1,h2,h3,navHeight){
        ...
        window.addEventListener('scroll',()=>{
          ...
          if (isIos) {
            if (bodyEle.scrollTop >= h3) {
              if (self.action === 2)  return false
              self.action = 2
            } else if (bodyEle.scrollTop >= h2) {
      ...
      toSubmitResults(event){
        ...
        console.log(obj)
        api.submitInsuranceInfoForQianhai(obj)
          .then(res=>{
      ...
      .goodsContainer{
        ...
        .goodsPlan{
          ...
          .goodsHeader{
            ...
            color:#fff;
            border-radius:5/@size;
            border-bottom:3/@size dashed #fff;
            .font32();
          }
          .goodsBody{
            padding:0 24/@size;
